...
The partial file is `SSC-CHSL/2024/2024-07-04_Shift-1_PARTIAL.json`; it contains 17 stems (14 Quant and 3 General Awareness), no recoverable options, and is not counted as a complete paper. Bulk-source discovery and acceptance decisions are tracked in [`verification/source_ledger.md`](verification/source_ledger.md); advertised collections remain candidates until actual binaries pass the 2–3 paper test.
